...
public class Edit_user extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel1.add(ln_icon);
        ln_icon.setBounds(20, 130, 40, 50);
        ...
        jPanel1.add(fnfield);
        fnfield.setBounds(60, 120, 260, 60);
        ...
        jPanel1.add(lnfield);
        lnfield.setBounds(60, 200, 260, 60);
        ...
        jPanel1.add(fn_icon);
        fn_icon.setBounds(20, 210, 40, 50);
        ...
        status_icon.setBounds(390, 210, 40, 40);
        ...
        jPanel1.add(efield);
        efield.setBounds(60, 280, 260, 60);
        ...
        jPanel1.add(pfield);
        pfield.setBounds(60, 360, 260, 60);
        ...
        jPanel1.add(ufield);
        ufield.setBounds(60, 440, 260, 60);
        ...
        jPanel1.add(update);
        update.setBounds(480, 560, 56, 19);
        ...
        user_icon.setBounds(390, 130, 40, 40);
        ...
        username_error.setBounds(110, 430, 210, 20);
        ...
        email_error.setBounds(110, 270, 210, 20);
        ...
        lname_error.setBounds(110, 190, 210, 20);
        ...
        name_error.setBounds(110, 110, 210, 20);
        ...
        contact_error.setBounds(110, 350, 210, 20);
       ...
       boolean valid = true;
            ...
            String u_id = user_id.getText().trim();  // Ensure user ID is properly trimmed
                 ...
                 if (fname.isEmpty()){
                     ...
                     displayError(name_error, "First name is empty!");
                     valid = false;
                 }

                 if (lname.isEmpty()) {
                     setInvalidTitledBorder(lnfield, "Last Name");
                     displayError(lname_error, "Last name is empty!");
                     valid = false;
                 }

                 if (email.isEmpty()) {
                     setInvalidTitledBorder(efield, "Email");
                     displayError(email_error, "Email is empty!");
                     valid = false;
                 ...
                 if (contact.isEmpty()) {
                     ...
                     displayError(contact_error, "Phone number is empty!");
                     valid = false;
                 ...
                 if (username.isEmpty()) {
                     ...
                     displayError(username_error, "Username is empty!");
                     valid = false;
                 }
            ...
            try {
                String query = "SELECT COUNT(*) FROM user WHERE (username = ? OR email = ?) AND u_id <> ?";
                try (PreparedStatement pst = cn.prepareStatement(query)) {
                    pst.setString(1, username);
                    pst.setString(2, email);
                    pst.setString(3, u_id);  // Exclude current user's ID
                    ...
                    try (ResultSet rs = pst.executeQuery()) {
                        if (rs.next()) {
                            ...
                            if (count > 0) {
                                ...
                                String checkQuery = "SELECT username, email FROM user WHERE (username = ? OR email = ?) AND u_id <> ?";
                                try (PreparedStatement checkPst = cn.prepareStatement(checkQuery)) {
                                    checkPst.setString(1, username);
                                    checkPst.setString(2, email);
                                    checkPst.setString(3, u_id);

                                    try (ResultSet checkRs = checkPst.executeQuery()) {
                                        while (checkRs.next()) {
                                            if (checkRs.getString("username").equals(username)) {
                                                usernameExists = true;
                                            }
                                            if (checkRs.getString("email").equals(email)) {
                                                emailExists = true;
                                            }
                                        }
                                    }
