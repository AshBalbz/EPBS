...
public class Users extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Title, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 140, 80));
         ...
         int row = user_tbl.getSelectedRow();
            ...
            try (Connection conn = db.getConnection();
                ...
                if (affectedRows > 0) {
                    ...
                    String action = "Deleted user with ID " + selectedUserId;
        ...
        if(rowIndex == -1){
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    Edit_User up = new Edit_User();
                    
                    JDesktopPane pane = getDesktopPane();
                    pane.add(up);
                    up.setVisible(true);
                    
                    up.user_id.setText(""+rs.getString("u_id"));
                    up.fnfield.setText(""+rs.getString("u_fname"));
                    up.lnfield.setText(""+rs.getString("u_lname"));
                    up.efield.setText(""+rs.getString("email"));
                    up.pfield.setText(""+rs.getString("contact"));
                    up.ufield.setText(""+rs.getString("username"));
                    up.role.setSelectedItem(""+rs.getString("role"));
                    up.stat.setSelectedItem(""+rs.getString("status"));
                    
                    Font FrankFont = new Font("Franklin Gothic Medium", Font.ITALIC, 16);

                    up.user_id.setFont(FrankFont);
                    up.user_id.setForeground(Color.WHITE);
                    up.user_id.setHorizontalAlignment(CENTER);
                    ...
                    up.ufield.setFont(FrankFont);
                    up.ufield.setForeground(Color.WHITE);
